...
import TasksDurationModerateTable from "@/components/tasks/TasksDurationModerateTable"

const TasksDurationModerate = () => {
    ...
    return (
        <div className='flex-1 relative z-10 overflow-auto'>
            <AdminHeader title={'Tasks Duration Moderate'} />
...
export default TasksDurationModerate