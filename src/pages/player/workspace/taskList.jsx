              ...
              <Slider {...sliderSettings}>
                {filteredTasks.map((task, index) => {
                  ...
                  return (
                    ...
                    >
                      <Card className="task-item relative mb-3 p-4" style={{ height: "375px" }}>
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                              <div className="flex flex-col text-lg gap-4">
                                <p
                                  ...
                                  title={task.taskDescription || "No description provided"}
                                >
                            ...
                            {task.status === 3 ? (
                              ...
                              <>
                                <Button
                                  ...
                                  onClick={() => handleTaskAction(task, index, "start")}
                                  className="bg-green-500 hover:bg-green-600"
                                  disabled={
                                    (activeTaskKey !== null && activeTaskKey !== taskKey) ||
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    handleTaskAction(
                                      task,
                                      index,
                                      currentTaskStatus === 1 ? "pause" : "resume"
                                    )
                                  }
                                  className={
                                    currentTaskStatus === 1
            ...
            <DialogContent className="max-w-lg bg-white rounded-xl shadow-2xl p-6 task-dialog">
                  ...
                  <div key={s} className="flex flex-col items-center">
                    ...
                    <span
                      className={`text-xs mt-1 ${
                        s === step ? "text-green-600 font-medium" : "text-gray-500"
                      }`}
                    >
                      {s === 1 && "Task Details"}
                      {s === 2 && "Focus Method"}
              ...
              {step === 2 && focusSuggestion && (
                <div className="space-y-2">
                  <div className="border rounded-xl p-3 bg-gray-50 space-y-2 shadow-sm">
                    ...
                    <p className="text-sm text-gray-700">{focusSuggestion.reason}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    {workDurationError && (
                      <p className="text-red-500 text-sm">{workDurationError}</p>
                    )}
              ...
              {step === 3 && (
                <div className="space-y-4">
                  ...
                  <p>
                    <strong>Total Duration:</strong> {taskCreateData.totalDuration} minutes
                  </p>
                  <p>
                    <strong>Start Date:</strong>{" "}
                  ...
                  <p>
                    <strong>Focus Method:</strong> {focusSuggestion?.focusMethodName}
                  </p>
                  <p>
                    <strong>Work Duration:</strong> {taskCreateData.workDuration} minutes
                  </p>
                  <p>
