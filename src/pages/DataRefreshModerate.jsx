...
const DataRefreshModerate = () => {
  ...
  const [openResetWeeklyPriorities, setOpenResetWeeklyPriorities] =
    useState(false);
  const [openResetDailyStatus, setOpenResetDailyStatus] = useState(false);
  const [openAutoPause, setOpenAutoPause] = useState(false);
  const [openHandleExpiredChallenges, setOpenHandleExpiredChallenges] =
    useState(false);
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-gray-400 text-sm">
            Handles expired challenges manually, updates the status of the
        ...
        <div className="flex items-center justify-between mb-4">
          <p />
          <p className="text-gray-400 text-sm">
            Updates the health of a specific tree (based on User Tree ID).
          </p>
        </div>
        <UserTreesTable />

        <Dialog
          open={openHandleExpiredChallenges}
          onOpenChange={setOpenHandleExpiredChallenges}
        >
                ...
                <Card className="bg-gray-800 text-white">
                  <CardHeader>
                    <CardDescription className="text-gray-400">
                      Handles expired challenges manually, updates the status of
                      the challenges and participants.
                    </CardDescription>
                  </CardHeader>
        ...
        <Dialog
          open={openResetWeeklyPriorities}
          onOpenChange={setOpenResetWeeklyPriorities}
        >
          <DialogContent className="dialog-overlay bg-gray-800 text-white">
            <DialogHeader>
        ...
        <Dialog
          open={openResetDailyStatus}
          onOpenChange={setOpenResetDailyStatus}
        >
          <DialogContent className="dialog-overlay bg-gray-800 text-white">
            <DialogHeader>
